...
For new users with at least a basic understanding of analysis methods such as the TRF, we suggest starting from the first How-to guide `Getting started <gettingStartedPage.rst>`_  
