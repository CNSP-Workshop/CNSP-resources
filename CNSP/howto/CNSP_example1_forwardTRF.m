...
% dataMainFolder = '../datasets/LalorNatSpeechReverse/'; % other possible datasets
% dataMainFolder = '../datasets/diliBach/';
% dataMainFolder = '../datasets/musicImagery/'; % this experiment had two
%                           % conditions. See the how-to guide/script on
%                           % multiple conditions
