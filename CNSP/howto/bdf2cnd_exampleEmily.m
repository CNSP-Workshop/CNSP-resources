...
subs = 7; %1:10;                % Subjects to process
...
% nCond = 2;                  % number of conditions, where conditions have the same audio-material
%                             % (e.g., listening vs. imagery;
%                             %        audio-visual vs. audio;
%                             %        speech vs. vocoded speech)
%                             % Specify nCond=1 if different stimuli for different
%                             % conditions.
...
% Preprocessing parameters (Emily's experiment)
